...
const ContactMethodCard = ({ icon, title, description, ctaText, ctaLink }) => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 hover:-translate-y-1 text-center flex flex-col items-center border border-gray-border/50">
      {/* Icon */}
      ...
      {/* Description */}
      <p className="text-sm text-gray-text leading-relaxed mb-5 flex-1">{description}</p>
