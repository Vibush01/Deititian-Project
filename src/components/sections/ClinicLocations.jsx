...
const ClinicLocations = ({ className = '' }) => {
  ...
  const mapEmbedUrl = `https://www.google.com/maps?q=${encodeURIComponent('Chandigarh, India')}&output=embed`
  ...
  return (
    <section className={`py-16 md:py-24 bg-white ${className}`}>
      <div className="container-custom">
        ...
        <div className="mt-12 md:mt-16 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          {/* Location Info */}
          <div className="w-full lg:w-1/2">
            <div className="bg-white border border-gray-100 rounded-2xl p-8 md:p-10 hover:shadow-lg transition-all duration-300 group max-w-lg mx-auto lg:mx-0">
