            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="relative flex items-center justify-center">
                <div className="relative z-10 -mr-6 md:-mr-12 hover:z-30 hover:scale-105 transition-transform duration-300">
                  <img src={fitjeevaDietitian} alt="Before transformation" className="w-40 md:w-56 h-40 md:h-56 object-cover rounded-full border-4 border-white shadow-xl grayscale" />
                ...
                <div className="relative z-20 hover:z-30 hover:scale-105 transition-transform duration-300">
                  <img src={fitjeevaClinical} alt="After transformation" className="w-48 md:w-64 h-48 md:h-64 object-cover rounded-full border-4 border-white shadow-2xl" />
